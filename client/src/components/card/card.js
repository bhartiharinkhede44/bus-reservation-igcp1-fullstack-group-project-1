...
const CustomerCard = () => {
    ...
    return (
        <>
            <div className="container1 main-container">
                <div className="container1 bg-light card-customer shadow mt-5 d-flex justify-content-evenly pt-4">
                    ...
                    <div className="content-head mt-4">
                        ...
                        <li>
                            <FontAwesomeIcon icon={⭐⭐⭐⭐⭐} className="font"/>
                            <FontAwesomeIcon icon={faStar} /> 
                            <FontAwesomeIcon icon={faStar} /> 
                            <FontAwesomeIcon icon={faStar} /> 
